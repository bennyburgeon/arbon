        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('permutations.create')}}" class="menu-link">
                    <div data-i18n="Add Customer">Add Words</div>
                  </a>
                </li>
              </ul>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('permutations.index')}}" class="menu-link">
                    <div data-i18n="Add Customer">List Words</div>
                  </a>
                </li>
              </ul>
            </li>
